  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
	...
	<body>
      ...
      <form class="widget_loginform" action="identificacion.php" method="post">
		...
		<input src="img/flecha_enter.png" alt="enviar datos de identificación" name="submit" id="submit_login_widget" class="image-enviar" type="image" />
	      </label>
	...
	<div class="content_doku">
            ...
            <form class="formIns" name="formUsuario" id="Identificarse" action="inscripcionUsuario.php" method="post" onsubmit="validarFormulario()">
